...
FORGEJO_REMOTE="git@git.wyrmnet.link:shoganaich/sysadmin-notes.git"
...
echo
echo "Push to all external remotes:"
echo "  git push github main && git push gitlab main && git push forgejo main"
